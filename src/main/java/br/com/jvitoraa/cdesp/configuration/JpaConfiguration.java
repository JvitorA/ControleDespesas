package br.com.jvitoraa.cdesp.configuration;
...
/**
 * Classe d configuração do JPA
 * @author jalmeial
 *
 */
@Configuration
@EnableJpaRepositories(basePackages = "br.com.jvitoraa.cdesp.repo",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "br.com.jvitoraa.cdesp.model" });
